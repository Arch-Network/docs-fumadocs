...
- **Running development environment** (see [Quick Start Guide](/docs/getting-started/quick-start))
...
<Cards>
  <Card title="Oracle Program Guide" href="/docs/guides/how-to-write-oracle-program">
