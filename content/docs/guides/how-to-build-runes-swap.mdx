...
- Completed the [environment setup](/docs/getting-started/requirements)
- A basic understanding of [Bitcoin Integration](/docs/concepts/bitcoin-integration)
...
<Cards>
  <Card title="Lending Protocol Guide" href="/docs/guides/how-to-build-lending-protocol">
    Build a lending protocol using your swap knowledge
  </Card>
  <Card title="Oracle Integration" href="/docs/guides/how-to-write-oracle-program">
...
<Cards>
  ...
  <Card title="Bitcoin Integration" href="/docs/concepts/bitcoin-integration">
