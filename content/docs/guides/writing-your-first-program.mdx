...
- **Running validator** (see [Validator Setup Guide](/docs/getting-started/bitcoin-and-titan-setup))
- **Basic Rust knowledge** and understanding of [Arch concepts](/docs/concepts/architecture)
...
<Cards>
  <Card title="Explore More Examples" href="/docs/guides/how-to-create-a-fungible-token">
    Learn how to create fungible tokens
  </Card>
  <Card title="Build an Oracle Program" href="/docs/guides/how-to-write-oracle-program">
