...
- **Solana/Agave CLI 3.1.9+** - provides `cargo-build-sbf`
...
<Cards>
  ...
  <Card title="Advanced Testing" href="/docs/development/writing-your-first-program">
    Learn comprehensive testing strategies
  </Card>
  <Card title="Program Architecture" href="/docs/development/writing-your-first-program">
...
- [SDK Documentation](/docs/tools-apis/sdk) - Client libraries and tools
- [API Reference](/docs/tools-apis/api-reference) - Complete API documentation
