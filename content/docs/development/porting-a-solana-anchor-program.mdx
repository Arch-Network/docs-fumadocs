...
The whole port is six stages. The map below doubles as a guide to this page — each box notes the section that covers it:

<Pipeline
  steps={[
    { label: "Convert", sub: "a2s", ref: "§4" },
    { label: "API rewrite", ref: "§5" },
    { label: "Build SBF", ref: "§7" },
    { label: "Deploy", ref: "§8" },
    { label: "Publish IDL", ref: "§9" },
    { label: "Verify decode", ref: "§10" },
  ]}
/>
...
<Compare
  keep={{
    title: "Carries over unchanged",
    items: [
      "Account model",
      "Lamports & rent",
      <>CPI: <code>invoke</code> / <code>invoke_signed</code></>,
      "BPF/SBF execution",
    ],
  }}
  change={{
    title: "What you must change",
    items: [
      <>Framework crates: <code>anchor</code> → <code>satellite</code></>,
      "Identity: hex IDs, secp256k1",
      "Sysvars → helpers",
      <>Token program → <code>apl-token</code></>,
...
```mermaid
%%{init: {"theme":"base","themeVariables":{"fontFamily":"Geist, sans-serif","primaryColor":"#efe9cf","primaryBorderColor":"#e0922e","primaryTextColor":"#181818","actorBkg":"#efe9cf","actorBorder":"#e0922e","actorTextColor":"#181818","actorLineColor":"#c98a3a","signalColor":"#9a5a2c","signalTextColor":"#5a3a1c","labelBoxBkgColor":"#f6d79a","labelBoxBorderColor":"#e0922e","labelTextColor":"#181818","loopTextColor":"#5a3a1c","noteBkgColor":"#f6d79a","noteBorderColor":"#e0922e","noteTextColor":"#181818","activationBkgColor":"#f3c873","activationBorderColor":"#e0922e","sequenceNumberColor":"#ffffff"}}}%%
sequenceDiagram
