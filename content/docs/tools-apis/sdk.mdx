...
const payerPubkey = new Uint8Array(32); // your payer pubkey
const recentBlockhash = await provider.getBestBlockHash();

const message = SanitizedMessageUtil.createSanitizedMessage(
  instructions, payerPubkey, recentBlockhash
);

const transaction = {
  version: 1,
  signatures: [/* your adjusted signature */],
  message,
};
...
- **GitHub Issues**: [arch-typescript-sdk/issues](https://github.com/Arch-Network/arch-typescript-sdk/issues)
...
<Cards>
  <Card title="TypeScript SDK Repository" href="https://github.com/Arch-Network/arch-typescript-sdk" external>
