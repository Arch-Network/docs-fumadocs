...
:::note
**RPC Method Availability**: For a complete list of which RPC methods are available in the `validator` vs `local_validator` crates, along with their correct parameter formats, see the [RPC Method Availability Guide](/docs/rpc/rpc-method-availability).
:::
...
<Cards>
  <Card title="RPC Method Availability" href="/docs/rpc/rpc-method-availability">
