...
# Create a swap offer
# Submit a RuntimeTransaction with the CreateOffer instruction using the SDK or RPC API

# Accept the offer
# Submit a RuntimeTransaction with the AcceptOffer instruction using the SDK or RPC API
```
...
# Deploy to testnet by selecting a testnet profile
arch-cli --profile testnet deploy target/deploy
```
...
arch-cli show <OFFER_ACCOUNT_PUBKEY>
