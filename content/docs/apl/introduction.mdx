...
A program for token metadata accounts and attribute PDAs:
- Metadata instruction handling
- Metadata and attributes PDA helpers
- Program ID: `MetaLUJnthcRKvy3ayXTnVcxaXqca1fbaQox8ChQqAk`
...
1. Familiarize yourself with the [Arch Network architecture](/docs/setup-infrastructure/architecture)
...
<Cards>
  ...
  <Card title="Token Metadata">
    Metadata accounts and attributes for APL tokens
  </Card>
</Cards>
